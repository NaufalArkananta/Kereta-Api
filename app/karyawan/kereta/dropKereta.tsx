        ...
        try {
            ...
            if(response.data.success === true) {
                toast(message, {
                    ...
                    containerId: `toastDrop-${myProp.kereta.name}`, 
                    type: `success`
                })
                setShow(false)
                // reload page
            ...
            console.log(error)
            toast(`Something went wrong`, {containerId: `toastDrop-${myProp.kereta.name}`, type: `success`})
        }
    }
    return (
        <div className="">
            <ToastContainer containerId={`toastDrop-${myProp.kereta.name}`} />
